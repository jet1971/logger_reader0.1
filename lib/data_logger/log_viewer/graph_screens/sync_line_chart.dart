                      ...
                      child: LineChart(
                        LineChartData(
                            ...
                            touchCallback: (FlTouchEvent event,
                              ...
                              setState(() {
                                if (touchResponse != null &&
                                  ...
                                  touchIndex = _findClosestSpotIndex(rpmSpots,
                          ...
                          borderData: FlBorderData(
                              show: true, border: Border.all(width: 0.2)),
                        ),
                      ),
                    ),
                    const SizedBox(
                            ...
                            touchCallback: (FlTouchEvent event,
                              ...
                              setState(() {
                                if (touchResponse != null &&
                                  ...
                                  touchIndex = _findClosestSpotIndex(speedSpots,
                                      touchResponse.lineBarSpots![0].x);
                            ...
                            touchCallback: (FlTouchEvent event,
                              ...
                              setState(() {
                                if (touchResponse != null &&
                                  ...
                                  touchIndex = _findClosestSpotIndex(afrSpots,
                                      touchResponse.lineBarSpots![0].x);
                            ...
                            touchCallback: (FlTouchEvent event,
                              ...
                              setState(() {
                                if (touchResponse != null &&
                                  ...
                                  touchIndex = _findClosestSpotIndex(tpsSpots,
                                      touchResponse.lineBarSpots![0].x);
