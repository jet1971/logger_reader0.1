...
class EngineDataGraph extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    List<FlSpot> rpmSpots = _convertToSpots(data, 'modRpm', 'timestamp', 13500); //the data, the data key, timestamp key, plausability tolerence value
    List<FlSpot> speedSpots = _convertToSpots(data, 'speed', 'timestamp', 20);
    List<FlSpot> batteryVoltageSpots = _convertToSpots(data, 'batteryVoltage', 'timestamp', 100);
    List<FlSpot> afrSpots = _convertToSpots(data, 'afr', 'timestamp', 30);
    List<FlSpot> tpsSpots = _convertToSpots(data, 'tps', 'timestamp', 100);
